...
var _stylis = __webpack_require__(40);
...
window.addEventListener("load", function () {
  var root = document.querySelector("[data-inline-search]");

  if (!root) {
    return;
  }

  var searchEndpoint = root.getAttribute("data-search-endpoint");
  if (searchEndpoint) {
    _reactDom2.default.render(_react2.default.createElement(_2.default, { searchEndpoint: searchEndpoint }), root);
  }
});
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(0);var invariant=__webpack_require__(5);var warning=__webpack_require__(7);var ExecutionEnvironment=__webpack_require__(11);var _assign=__webpack_require__(4);var emptyFunction=__webpack_require__(2);var EventListener=__webpack_require__(12);var getActiveElement=__webpack_require__(13);var shallowEqual=__webpack_require__(14);var containsNode=__webpack_require__(15);var focusNode=__webpack_require__(16);var emptyObject=__webpack_require__(6);var checkPropTypes=__webpack_require__(8);var hyphenateStyleName=__webpack_require__(27);var camelizeStyleName=__webpack_require__(29);/**
 * WARNING: DO NOT manually require this module.
 * This is a replacement for `invariant(...)` used by the error code system
 * and will _only_ be required by the corresponding babel pass.
 * It always throws.
...
var _InlineSearch = __webpack_require__(32);

var _InlineSearch2 = _interopRequireDefault(_InlineSearch);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _InlineSearch2.default;
...
var _reactClickOutside = __webpack_require__(42);
...
var InlineSearch = function (_React$Component) {
  _inherits(InlineSearch, _React$Component);

  function InlineSearch(props) {
    _classCallCheck(this, InlineSearch);

    var _this = _possibleConstructorReturn(this, (InlineSearch.__proto__ || Object.getPrototypeOf(InlineSearch)).call(this, props));

    _this.getSearchUrl = function (_ref) {
      var searchTerm = _ref.searchTerm,
          currentPage = _ref.currentPage;
      return _this.props.searchEndpoint + '?search=' + searchTerm + '&page=' + currentPage + '&per_page=' + _this.props.perPage;
    };

    _this.maybeResetToPageOne = function (prevSearchTerm) {
      return new Promise(function (resolve) {
        if (prevSearchTerm === _this.state.searchTerm) {
          resolve();
          return;
        }

        _this.setState({ currentPage: 1 }, resolve);
      });
    };

    _this.onSearchTermChange = function (event) {
    ...
    _this.render = function () {
      var _ref2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _this.state,
          searchTerm = _ref2.searchTerm,
          showingResults = _ref2.showingResults,
      ...
      return _react2.default.createElement(
        StyledContainer,
        null,
        _react2.default.createElement(_SearchButton.SearchButton, { searching: searchTerm.length > 0 }),
        _react2.default.createElement(_SearchInput.SearchInput, { searchTerm: searchTerm, onChange: _this.onSearchTermChange }),
        _react2.default.createElement(_Results.Results, {
          ...
          closeSearch: _this.closeSearch,
          onPageDown: _this.onPageDown,
          onPageUp: _this.onPageUp,
          loading: loading
        })
      );
    };
    ...
    _this.maybeSearch = (0, _debounce2.default)(_this.maybeSearch.bind(_this), 200);
    _this.onPageDown = _this.onPageDown.bind(_this);
    _this.onPageUp = _this.onPageUp.bind(_this);
  ...
  _createClass(InlineSearch, [{
    key: 'componentDidUpdate',
    value: function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee(prevProps, prevState) {
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (!(this.state.searchTerm !== prevState.searchTerm || this.state.currentPage !== prevState.currentPage)) {
                  _context.next = 4;
                  break;
                }

                _context.next = 3;
                return this.maybeResetToPageOne(prevState.searchTerm);
    ...
    key: 'maybeSearch',
    value: function maybeSearch() {
      var _this2 = this;

      var _ref4 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.state,
    ...
    value: function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
        var _ref6 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.state,
            searchTerm = _ref6.searchTerm,
            currentPage = _ref6.currentPage;

        var url, response, results, newState;
...
InlineSearch.propTypes = {
  searchEndpoint: _propTypes2.default.string.isRequired,
  perPage: _propTypes2.default.number
};
InlineSearch.defaultProps = {
  perPage: 5
};
exports.default = (0, _reactClickOutside2.default)(InlineSearch);
...
var hoistNonReactStatic = __webpack_require__(43);
...
var _PrevNext = __webpack_require__(47);

var _NoResults = __webpack_require__(48);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _taggedTemplateLiteral(strings, raw) { return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }

var StyledResults = _styledComponents2.default.div(_templateObject, function (_ref) {
  var showingResults = _ref.showingResults;
  return showingResults ? 'block' : 'none';
});

var StyledCloseButton = _styledComponents2.default.button(_templateObject2);

var Results = exports.Results = function Results(_ref2) {
  var showingResults = _ref2.showingResults,
      currentPage = _ref2.currentPage,
      totalPages = _ref2.totalPages,
      results = _ref2.results,
      searchTerm = _ref2.searchTerm,
      loading = _ref2.loading,
      closeSearch = _ref2.closeSearch,
      onPageDown = _ref2.onPageDown,
      onPageUp = _ref2.onPageUp;
  return _react2.default.createElement(
    StyledResults,
    { showingResults: showingResults },
    ...
    _react2.default.createElement(StyledCloseButton, {
      dangerouslySetInnerHTML: { __html: '&Cross;' },
      onClick: closeSearch
    }),
    results.length > 0 ? results.filter(function (result) {
      return result.title && result.title.rendered.length;
    }).map(function (result) {
      return _react2.default.createElement(_result.Result, _extends({ key: result.id }, result));
    }) : _react2.default.createElement(_NoResults.NoResults, null),
    _react2.default.createElement(_PrevNext.PrevNext, {
      currentPage: currentPage,
...
var StyledResult = _styledComponents2.default.div(_templateObject);
  ...
  return title ? _react2.default.createElement(
    ...
    _react2.default.createElement('a', {
      ...
      dangerouslySetInnerHTML: {
        __html: title.rendered.replace(' ,', '').replace(' &nbsp;&nbsp;,', '')
      }
    })
  ) : null;
};
...
var StyledPrevNext = _styledComponents2.default.div(_templateObject);

var StyledPrevNextButton = _styledComponents2.default.button(_templateObject2);

var StyledLoadingText = _styledComponents2.default.div(_templateObject3);

var PrevNext = exports.PrevNext = function PrevNext(_ref) {
  ...
  return _react2.default.createElement(
    StyledPrevNext,
    null,
    _react2.default.createElement(StyledPrevNextButton, {
      dangerouslySetInnerHTML: {
    ...
    _react2.default.createElement(StyledPrevNextButton, {
      style: currentPage >= totalPages ? { pointerEvents: 'none', outline: 'none' } : {},
...
var StyledNoResults = _styledComponents2.default.span(_templateObject);
...
var StyledSearchButton = _styledComponents2.default.button(_templateObject, function (_ref) {
  var searching = _ref.searching;
  return searching ? 'none' : 'auto';
}, function (_ref2) {
  var searching = _ref2.searching;
  return searching ? '0' : '1';
});

var SearchButton = exports.SearchButton = function SearchButton(_ref3) {
  var searching = _ref3.searching;
  return _react2.default.createElement(
    StyledSearchButton,
    { searching: searching, tabIndex: '-1' },
    'Search'
  );
};
...
/***/ })
/******/ ]);
//# sourceMappingURL=wp-react-inline-search.js.map